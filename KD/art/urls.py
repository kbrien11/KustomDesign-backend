...
urlpatterns = [
    ...
    path("home_images", views.home_images),
    ...
    path("imagePerArtist/<username>/<artist_id>", views.imagePerArtist),
    path("totalArtistImages", views.totalArtistsImages),
    path(
        "artistProfilePiceture/<artist_username>/<artist_id>",
        views.artist_profile_picture,
    ),
]
